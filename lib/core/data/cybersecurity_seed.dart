const List<Map<String, Object>> cybersecurityTopicsSeed = [
  ...
  },
  {
    ...
    'category': 'linux',
    'short_description':
        'Learn Linux fundamentals from architecture to system-level thinking.',
    'description':
        'An introduction to Linux system concepts, architecture, kernel behavior, process handling, file systems, memory management, security, and system-level thinking for beginners and intermediate learners.',
    'order': 11,
    'difficulty': 'Beginner',
    'estimated_lesson_count': 1,
    'icon': 'terminal_rounded',
    'illustration':
        'Terminal window, kernel gear icon, and layered system diagram for Linux learning.',
    'color_tag': '#DDEBFF',
    'home_preview':
        'Build Linux system intuition from history, kernel, and processes to security.',
  },
  {
    'id': 'linux-design-principles',
    'title': 'The Linux System: Design Principles',
    'category': 'linux',
    'short_description':
        'Understand modular Linux design and kernel/user-space separation.',
    'description':
        'Explore Linux design philosophy including simplicity, modularity, multitasking, and portability fundamentals.',
    'order': 12,
    'difficulty': 'Beginner',
    'estimated_lesson_count': 1,
    'icon': 'design_services_rounded',
    'illustration': 'Simple modules connected to a central Linux core.',
    'color_tag': '#E4EEFF',
  },
  {
    'id': 'linux-kernel-architecture',
    'title': 'The Linux System: Kernel and Architecture',
    'category': 'linux',
    'short_description':
        'Learn kernel modules and how Linux components interact.',
    'description':
        'Understand the Linux kernel, modular architecture, and why component boundaries matter.',
    'order': 13,
    'difficulty': 'Intermediate',
    'estimated_lesson_count': 1,
    'icon': 'settings_input_component_rounded',
    'illustration': 'Kernel ring with plug-in modules around it.',
    'color_tag': '#DEE7FB',
  },
  {
    'id': 'linux-process-management',
    'title': 'The Linux System: Process Management',
    'category': 'linux',
    'short_description':
        'Track process states, fork/exec flow, and parent-child behavior.',
    'description':
        'Understand process lifecycle and practical process handling in Linux systems.',
    'order': 14,
    'difficulty': 'Intermediate',
    'estimated_lesson_count': 1,
    'icon': 'account_tree_rounded',
    'illustration': 'Process tree branching from init process.',
    'color_tag': '#E7EDFF',
  },
  {
    'id': 'linux-scheduling',
    'title': 'The Linux System: Scheduling',
    'category': 'linux',
    'short_description':
        'See how Linux balances fairness and responsiveness on CPU.',
    'description':
        'Learn scheduler basics and why CPU scheduling affects real-world performance.',
    'order': 15,
    'difficulty': 'Intermediate',
    'estimated_lesson_count': 1,
    'icon': 'schedule_rounded',
    'illustration': 'CPU queue timeline with rotating tasks.',
    'color_tag': '#EAF2FF',
  },
  {
    'id': 'linux-memory-management',
    'title': 'The Linux System: Memory Management',
    'category': 'linux',
    'short_description':
        'Understand virtual memory, paging, allocation, and swap.',
    'description':
        'Build practical memory intuition for Linux system efficiency and stability.',
    'order': 16,
    'difficulty': 'Intermediate',
    'estimated_lesson_count': 1,
    'icon': 'memory_rounded',
    'illustration': 'Virtual to physical memory mapping blocks.',
    'color_tag': '#E2F0FF',
  },
  {
    'id': 'linux-file-systems',
    'title': 'The Linux System: File Systems',
    'category': 'linux',
    'short_description':
        'Learn hierarchy, permissions, ownership, and mounting concepts.',
    'description':
        'Study Linux file system foundations and secure file handling basics.',
    'order': 17,
    'difficulty': 'Beginner',
    'estimated_lesson_count': 1,
    'icon': 'folder_open_rounded',
    'illustration': 'Directory tree with ownership and permission tags.',
    'color_tag': '#E8F4FF',
  },
  {
    'id': 'linux-io-device-interaction',
    'title': 'The Linux System: I/O and Device Interaction',
    'category': 'linux',
    'short_description':
        'Master streams, redirection, and Linux device interaction basics.',
    'description':
        'Understand standard I/O and how Linux abstracts hardware interaction.',
    'order': 18,
    'difficulty': 'Beginner',
    'estimated_lesson_count': 1,
    'icon': 'sync_alt_rounded',
    'illustration': 'Terminal streams routed between commands and devices.',
    'color_tag': '#DDF3FF',
  },
  {
    'id': 'linux-ipc',
    'title': 'The Linux System: Interprocess Communication',
    'category': 'linux',
    'short_description':
        'Explore pipes, signals, and shared memory in beginner form.',
    'description':
        'Learn why processes communicate and which IPC methods fit common scenarios.',
    'order': 19,
    'difficulty': 'Intermediate',
    'estimated_lesson_count': 1,
    'icon': 'compare_arrows_rounded',
    'illustration': 'Two process nodes exchanging messages via IPC channels.',
    'color_tag': '#E6F0FF',
  },
  {
    'id': 'linux-networking-security',
    'title': 'The Linux System: Networking and Security',
    'category': 'linux',
    'short_description':
        'Connect networking fundamentals with Linux security practices.',
    'description':
        'Cover users, groups, permissions, and safe Linux system usage habits.',
    'order': 20,
    'difficulty': 'Intermediate',
    'estimated_lesson_count': 1,
    'icon': 'admin_panel_settings_rounded',
    'illustration': 'Network links with user/group security shield overlay.',
    'color_tag': '#E0EAFF',
  },
];
...
const List<Map<String, Object>> cybersecurityLessonsSeed = [
  ...
  {
    'id': 'linux-l1',
    'topic_id': 'linux-system',
    'title': 'Linux History and Overview',
    'summary':
        'Understand what Linux is, where it came from, and why it matters.',
    'learning_objective':
        'Explain Linux origins, open-source values, and distribution ecosystem.',
    'content':
        'Linux is an open-source operating system kernel that powers servers, cloud platforms, mobile systems, and embedded devices. Its growth comes from a collaborative model where people improve shared code. Linux distributions package the kernel with tools and software for different needs, such as Ubuntu, Fedora, and Debian. Knowing this history helps learners understand why Linux is central to software development and modern infrastructure.',
    'completion_steps': [
      'Identify what Linux refers to: kernel plus ecosystem.',
      'List one historical milestone and one distribution example.',
      'Explain why open source accelerated Linux adoption.',
    ],
    'minutes': 8,
    'order': 1,
  },
  {
    'id': 'linux-l2',
    'topic_id': 'linux-design-principles',
    'title': 'Linux Design Principles',
    'summary':
        'Learn Linux philosophy: modularity, multiuser support, and flexibility.',
    'learning_objective':
        'Describe Linux design choices and kernel-space vs user-space separation.',
    'content':
        'Linux follows practical design principles: keep components simple, combine small tools, and support many users and processes efficiently. The system separates kernel-space and user-space so critical operations stay protected while applications run with controlled privileges. This balance gives Linux portability across hardware platforms and flexibility for both desktop and enterprise workloads.',
    'completion_steps': [
      'Define simplicity and modularity in Linux terms.',
      'Differentiate kernel-space and user-space responsibilities.',
      'Describe one benefit of Linux portability.',
    ],
    'minutes': 9,
    'order': 1,
  },
  {
    'id': 'linux-l3',
    'topic_id': 'linux-kernel-architecture',
    'title': 'Kernel Modules and Linux Architecture',
    'summary':
        'Explore kernel internals and modular architecture fundamentals.',
    'learning_objective':
        'Explain what kernel modules are and how Linux components interact.',
    'content':
        'The Linux kernel is the core layer that manages hardware, memory, scheduling, and system calls. Kernel modules let functionality be added or removed without rebuilding the entire kernel, improving maintainability and adaptability. Device drivers, file systems, and networking features can be loaded as needed. This modular architecture helps Linux scale across many environments while staying efficient.',
    'completion_steps': [
      'Define kernel responsibilities in one sentence.',
      'Explain why modules improve maintainability.',
      'Name one component commonly implemented as a module.',
    ],
    'minutes': 10,
    'order': 1,
  },
  {
    'id': 'linux-l4',
    'topic_id': 'linux-process-management',
    'title': 'Process Management in Linux',
    'summary':
        'Understand process lifecycle, fork/exec model, and monitoring basics.',
    'learning_objective':
        'Describe process states and parent-child creation flow in Linux.',
    'content':
        'A process is a running instance of a program with its own memory and state. Linux tracks process states such as running, waiting, or stopped. New processes are often created through fork, then replaced with program code through exec. Parent-child relationships help organize execution and control. Monitoring processes is essential for troubleshooting performance and stability.',
    'completion_steps': [
      'List three common process states.',
      'Explain fork and exec at a high level.',
      'Describe why process monitoring matters in operations.',
    ],
    'minutes': 10,
    'order': 1,
  },
  {
    'id': 'linux-l5',
    'topic_id': 'linux-scheduling',
    'title': 'Linux Scheduling',
    'summary': 'Learn how Linux shares CPU time fairly across tasks.',
    'learning_objective':
        'Explain scheduling goals and the tradeoff between fairness and responsiveness.',
    'content':
        'Linux scheduling decides which process runs on the CPU and for how long. Good scheduling balances fairness with responsiveness so interactive tasks feel fast while background work still progresses. Modern Linux schedulers aim to distribute CPU time efficiently across workloads. Understanding scheduler behavior helps explain latency and throughput differences in real systems.',
    'completion_steps': [
      'Define fairness and responsiveness in scheduling.',
      'Describe why multitasking needs scheduler policies.',
      'Connect scheduling decisions to user-perceived performance.',
    ],
    'minutes': 9,
    'order': 1,
  },
  {
    'id': 'linux-l6',
    'topic_id': 'linux-memory-management',
    'title': 'Memory Management in Linux',
    'summary':
        'Build intuition for virtual memory, paging, allocation, and swap.',
    'learning_objective':
        'Differentiate physical and virtual memory and explain paging basics.',
    'content':
        'Linux uses virtual memory to give processes isolated address spaces and efficient memory usage. Physical memory is real RAM, while virtual memory is an abstraction mapped by the kernel. Paging moves memory in fixed-size units and swap can extend available space when RAM is constrained. Efficient allocation and memory policies improve performance and system stability.',
    'completion_steps': [
      'Compare physical vs virtual memory.',
      'Explain paging using simple language.',
      'Describe when swap helps and when it can hurt performance.',
    ],
    'minutes': 10,
    'order': 1,
  },
  {
    'id': 'linux-l7',
    'topic_id': 'linux-file-systems',
    'title': 'Linux File Systems',
    'summary': 'Understand hierarchy, permissions, and mounting fundamentals.',
    'learning_objective':
        'Explain Linux file hierarchy and basic permission model.',
    'content':
        'Linux organizes storage with a hierarchical directory tree rooted at /. Files and directories have ownership and permissions controlling read, write, and execute access. Mounting attaches file systems into this tree so users and apps can access them consistently. Understanding these ideas is key to navigation, security, and system administration.',
    'completion_steps': [
      'Identify the root role in Linux hierarchy.',
      'Interpret basic rwx permission meaning.',
      'Explain what mounting does conceptually.',
    ],
    'minutes': 9,
    'order': 1,
  },
  {
    'id': 'linux-l8',
    'topic_id': 'linux-io-device-interaction',
    'title': 'Input, Output, and Device Interaction',
    'summary':
        'Learn Linux streams, redirection, and how devices appear in the system.',
    'learning_objective':
        'Use standard input/output/error concepts to explain shell I/O behavior.',
    'content':
        'Linux treats many resources as files, including devices, which simplifies interaction patterns. Standard streams (stdin, stdout, stderr) let programs receive input and produce output predictably. Redirection and piping connect commands into workflows without changing program code. These concepts are core to productive Linux terminal usage and automation.',
    'completion_steps': [
      'Define stdin, stdout, and stderr.',
      'Describe redirection and piping in one practical scenario.',
      'Explain why Linux device abstraction improves consistency.',
    ],
    'minutes': 9,
    'order': 1,
  },
  {
    ...
    'summary':
        'Understand pipes, signals, and shared memory at a beginner level.',
    'learning_objective':
        'Describe why processes communicate and identify common IPC methods.',
    'content':
        'Processes often need to coordinate work or share data, so Linux provides multiple IPC mechanisms. Pipes connect output of one process to input of another, signals notify processes about events, and shared memory enables faster data exchange. Each IPC method has different tradeoffs in speed, complexity, and control. Knowing the basics helps when debugging distributed or concurrent behavior.',
    'completion_steps': [
      'Explain why isolated processes still need communication.',
      'Match pipes, signals, and shared memory to suitable use cases.',
      'Describe one IPC tradeoff in simple terms.',
    ],
    'minutes': 10,
    'order': 1,
  },
  {
    'id': 'linux-l10',
    'topic_id': 'linux-networking-security',
    'title': 'Linux Networking and Security',
    'summary':
        'Connect Linux networking basics with permissions and safe usage habits.',
    'learning_objective':
        'Apply beginner Linux security thinking using users, groups, and permissions.',
    'content':
        'Linux networking includes interfaces, routing basics, and services communicating over protocols. Security starts with users and groups, ownership rules, and least-privilege permissions. Safe practices include regular updates, careful privilege escalation, and service hardening. These habits create a reliable baseline for secure Linux administration.',
    'completion_steps': [
      'Explain users, groups, and ownership roles.',
      'Connect permission hygiene to security outcomes.',
      'List two safe Linux system usage practices.',
    ],
    'minutes': 10,
    'order': 1,
  },
...
const List<Map<String, Object>> cybersecurityQuizzesSeed = [
  ...
  {
    'id': 'quiz-linux-system',
    'topic_id': 'linux-system',
    'title': 'The Linux System Quiz',
    'question_count': 5,
    'difficulty': 'Intermediate',
  },
  {
    'id': 'quiz-linux-design-principles',
    'topic_id': 'linux-design-principles',
    'title': 'Linux Design Principles Quiz',
    'question_count': 5,
    'difficulty': 'Beginner',
  },
  {
    'id': 'quiz-linux-kernel-architecture',
    'topic_id': 'linux-kernel-architecture',
    'title': 'Kernel and Architecture Quiz',
    'question_count': 5,
    'difficulty': 'Intermediate',
  },
  {
    'id': 'quiz-linux-process-management',
    'topic_id': 'linux-process-management',
  ...
  {
    'id': 'quiz-linux-scheduling',
    'topic_id': 'linux-scheduling',
    'title': 'Linux Scheduling Quiz',
    'question_count': 5,
    'difficulty': 'Intermediate',
  },
  {
    'id': 'quiz-linux-memory-management',
    'topic_id': 'linux-memory-management',
  ...
  {
    'id': 'quiz-linux-file-systems',
    'topic_id': 'linux-file-systems',
    'title': 'Linux File Systems Quiz',
    'question_count': 5,
    'difficulty': 'Beginner',
  },
  {
    'id': 'quiz-linux-io-device-interaction',
    'topic_id': 'linux-io-device-interaction',
    'title': 'I/O and Device Interaction Quiz',
    'question_count': 5,
    'difficulty': 'Beginner',
  },
  {
    'id': 'quiz-linux-ipc',
    'topic_id': 'linux-ipc',
    'title': 'Interprocess Communication Quiz',
    'question_count': 5,
    'difficulty': 'Intermediate',
  },
  {
    'id': 'quiz-linux-networking-security',
    'topic_id': 'linux-networking-security',
    'title': 'Linux Networking and Security Quiz',
    'question_count': 5,
    'difficulty': 'Intermediate',
  },
];
...
const List<Map<String, Object>> cybersecurityQuizQuestionsSeed = [
  ...
  {
    'id': 'linux-q1',
    'quiz_id': 'quiz-linux-system',
    'topic_id': 'linux-system',
    'prompt': 'Which statement best describes Linux in modern computing?',
    'options': [
      'It is only a desktop theme engine',
      'It is an open-source OS kernel used across many systems',
      'It replaces all programming languages',
      'It runs only on one hardware type',
    ],
    'correct_index': 1,
    'explanation':
        'Linux is an open-source kernel powering servers, cloud, mobile, and embedded devices.',
    'order': 1,
  },
  {
    'id': 'linux-q2',
    ...
    'topic_id': 'linux-system',
    'prompt':
        'Why does separating kernel-space and user-space improve system design?',
    'options': [
      'It makes all programs run as root',
      'It helps isolate critical operations and improves safety',
      'It disables multitasking',
      'It removes the need for memory management',
    ],
    'correct_index': 1,
    'explanation':
        'Isolation protects kernel functions and reduces risk from user-space faults.',
    'order': 2,
  },
  {
    'id': 'linux-q3',
    ...
    'topic_id': 'linux-system',
    'prompt':
        'A process uses fork followed by exec. What is the main purpose of this pattern?',
    'options': [
      'Encrypt disk partitions automatically',
      'Create a child process and load a target program',
      'Disable scheduling for parent process',
      'Increase swap space immediately',
    ],
    'correct_index': 1,
    'explanation':
        'fork creates a child, and exec replaces it with the intended executable program.',
    'order': 3,
  },
  {
    'id': 'linux-q4',
    'quiz_id': 'quiz-linux-system',
    'topic_id': 'linux-system',
    'prompt': 'What is the key advantage of virtual memory in Linux systems?',
    'options': [
      'It removes need for permissions',
      'It gives isolated address spaces and efficient memory use',
      'It guarantees zero latency',
      'It eliminates all disk usage',
    ],
    'correct_index': 1,
    'explanation':
        'Virtual memory improves isolation and flexibility while the kernel maps it to physical RAM.',
    'order': 4,
  },
  {
    'id': 'linux-q5',
    ...
    'topic_id': 'linux-system',
    'prompt':
        'Which Linux practice most directly supports secure day-to-day system usage?',
    'options': [
      'Granting all users full write access',
      'Using least privilege with proper ownership and permissions',
      'Disabling updates for stability',
      'Running all services as the same account',
    ],
    'correct_index': 1,
    'explanation':
        'Least privilege and correct ownership/permissions are foundational Linux security controls.',
    'order': 5,
  },
  {
    'id': 'linux-dp-q1',
    'quiz_id': 'quiz-linux-design-principles',
    'topic_id': 'linux-design-principles',
    'prompt': 'Which design value is central in Linux tooling philosophy?',
    'options': [
      'One large tool for every task',
      'Small modular tools that compose well',
      'No command-line usage',
      'Avoid multiuser support',
    ],
    'correct_index': 1,
    'explanation':
        'Linux emphasizes small components that can be combined into powerful workflows.',
    'order': 1,
  },
  {
    'id': 'linux-dp-q2',
    'quiz_id': 'quiz-linux-design-principles',
    'topic_id': 'linux-design-principles',
    'prompt': 'Kernel-space and user-space separation mainly improves what?',
    'options': [
      'Screen brightness',
      'System safety and stability',
      'Disk size automatically',
      'Compiler speed only',
    ],
    'correct_index': 1,
    'explanation':
        'Privileged kernel operations are isolated from user applications for protection.',
    'order': 2,
  },
  {
    'id': 'linux-dp-q3',
    'quiz_id': 'quiz-linux-design-principles',
    'topic_id': 'linux-design-principles',
    'prompt': 'What does multiuser design in Linux enable?',
    'options': [
      'Only one user can log in',
      'Parallel access with permission controls',
      'No process isolation',
      'Mandatory GUI sessions',
    ],
    'correct_index': 1,
    'explanation':
        'Linux supports multiple users with controlled access policies.',
    'order': 3,
  },
  {
    'id': 'linux-dp-q4',
    'quiz_id': 'quiz-linux-design-principles',
    'topic_id': 'linux-design-principles',
    'prompt': 'Why is portability important in Linux design?',
    'options': [
      'It limits Linux to one CPU family',
      'It allows Linux to run across different hardware',
      'It removes need for drivers',
      'It disables package managers',
    ],
    'correct_index': 1,
    'explanation':
        'Portability helps Linux serve desktops, servers, cloud, and embedded devices.',
    'order': 4,
  },
  {
    'id': 'linux-dp-q5',
    'quiz_id': 'quiz-linux-design-principles',
    'topic_id': 'linux-design-principles',
    'prompt': 'Which scenario best reflects Linux modularity?',
    'options': [
      'Rebuilding whole OS to add one feature',
      'Adding needed components without changing everything',
      'Disabling shell scripting',
      'Running all services in one binary',
    ],
    'correct_index': 1,
    'explanation':
        'Modularity lets systems evolve with fewer broad side effects.',
    'order': 5,
  },
  {
    'id': 'linux-ka-q1',
    'quiz_id': 'quiz-linux-kernel-architecture',
    'topic_id': 'linux-kernel-architecture',
    'prompt': 'What is the Linux kernel primarily responsible for?',
    'options': [
      'Social media APIs',
      'Managing hardware and core system resources',
      'Replacing user applications',
      'Rendering web pages',
    ],
    'correct_index': 1,
    'explanation':
        'The kernel controls low-level resources like CPU, memory, and devices.',
    'order': 1,
  },
  {
    'id': 'linux-ka-q2',
    'quiz_id': 'quiz-linux-kernel-architecture',
    'topic_id': 'linux-kernel-architecture',
    'prompt': 'Kernel modules are useful because they:',
    'options': [
      'Eliminate all hardware differences',
      'Allow extending kernel features without full rebuilds',
      'Only run in user-space',
      'Prevent updates',
    ],
    'correct_index': 1,
    'explanation':
        'Modules can be loaded when needed, keeping systems flexible.',
    'order': 2,
  },
  {
    'id': 'linux-ka-q3',
    'quiz_id': 'quiz-linux-kernel-architecture',
    'topic_id': 'linux-kernel-architecture',
    'prompt': 'Which component is often delivered as a kernel module?',
    'options': [
      'Web browser tab',
      'Device driver',
      'Markdown file',
    ...
    'correct_index': 1,
    'explanation': 'Drivers are common module-based kernel extensions.',
    'order': 3,
  },
  {
    'id': 'linux-ka-q4',
    'quiz_id': 'quiz-linux-kernel-architecture',
    'topic_id': 'linux-kernel-architecture',
    'prompt': 'Why does architecture layering matter in Linux?',
    'options': [
      'It removes troubleshooting need',
      'It improves maintainability and clearer boundaries',
      'It forces single-user mode only',
      'It disables networking',
    ],
    'correct_index': 1,
    'explanation':
        'Layered designs help teams reason about responsibilities and changes.',
    'order': 4,
  },
  {
    'id': 'linux-ka-q5',
    'quiz_id': 'quiz-linux-kernel-architecture',
    'topic_id': 'linux-kernel-architecture',
    'prompt': 'If a module is faulty, a practical risk is:',
    'options': [
      'Only app theme breaks',
      'Kernel instability because modules run with high privileges',
      'Battery level doubles',
      'Compiler no longer exists',
    ],
    'correct_index': 1,
    'explanation':
        'Kernel-level code has elevated access and can affect system stability.',
    'order': 5,
  },
  {
    'id': 'linux-pm-q1',
    'quiz_id': 'quiz-linux-process-management',
    'topic_id': 'linux-process-management',
    'prompt': 'A process in Linux is best described as:',
    'options': [
      'A static source file',
      'A running instance of a program',
      'A network cable profile',
      'A GUI theme',
    ],
    'correct_index': 1,
    'explanation': 'Programs become processes when executed by the OS.',
    'order': 1,
  },
  {
    'id': 'linux-pm-q2',
    'quiz_id': 'quiz-linux-process-management',
    'topic_id': 'linux-process-management',
    'prompt': 'What does fork usually do?',
    'options': [
      'Deletes the parent process',
      'Creates a child process',
      'Encrypts memory pages',
      'Disables scheduling',
    ],
    'correct_index': 1,
    'explanation': 'fork duplicates process context to create a child.',
    'order': 2,
  },
  {
    'id': 'linux-pm-q3',
    'quiz_id': 'quiz-linux-process-management',
    'topic_id': 'linux-process-management',
    'prompt': 'exec is typically used to:',
    'options': [
      'Replace current process image with another program',
      'Stop all child processes globally',
      'Format file systems',
      'Change kernel version',
    ],
    'correct_index': 0,
    'explanation':
        'exec loads a new program into the existing process context.',
    'order': 3,
  },
  {
    'id': 'linux-pm-q4',
    'quiz_id': 'quiz-linux-process-management',
    'topic_id': 'linux-process-management',
    'prompt': 'Why monitor process states in operations?',
    'options': [
      'To style terminal output',
      'To detect hangs, load issues, or failures early',
      'To disable logs',
      'To remove user accounts',
    ],
    'correct_index': 1,
    'explanation':
        'State visibility helps diagnose resource and stability issues.',
    'order': 4,
  },
  {
    'id': 'linux-pm-q5',
    'quiz_id': 'quiz-linux-process-management',
    'topic_id': 'linux-process-management',
    'prompt': 'Parent-child process relationship mainly helps with:',
    'options': [
      'Network speed boosts',
      'Lifecycle control and structured execution',
      'Bypassing permissions',
      'Removing logs',
    ],
    'correct_index': 1,
    'explanation':
        'Process hierarchy supports control, signaling, and cleanup workflows.',
    'order': 5,
  },
  {
    'id': 'linux-sch-q1',
    'quiz_id': 'quiz-linux-scheduling',
    'topic_id': 'linux-scheduling',
    'prompt': 'CPU scheduling determines:',
    'options': [
      'Disk format style',
      'Which process runs and when',
      'Password complexity rules',
      'DNS records',
    ],
    'correct_index': 1,
    'explanation': 'Schedulers allocate CPU time across competing processes.',
    'order': 1,
  },
  {
    'id': 'linux-sch-q2',
    'quiz_id': 'quiz-linux-scheduling',
    'topic_id': 'linux-scheduling',
    'prompt': 'Why is responsiveness important for interactive apps?',
    'options': [
      'It reduces file count',
      'Users perceive lower latency and smoother behavior',
      'It disables background tasks',
      'It removes context switching',
    ],
    'correct_index': 1,
    'explanation':
        'Responsive scheduling improves user experience under mixed workloads.',
    'order': 2,
  },
  {
    'id': 'linux-sch-q3',
    'quiz_id': 'quiz-linux-scheduling',
    'topic_id': 'linux-scheduling',
    'prompt': 'Fairness in scheduling generally means:',
    'options': [
      'One process always runs first',
      'Processes receive balanced CPU opportunity over time',
      'All tasks run simultaneously on one core',
      'Kernel never preempts tasks',
    ],
    'correct_index': 1,
    'explanation': 'Fair policies avoid starvation and improve system balance.',
    'order': 3,
  },
  {
    'id': 'linux-sch-q4',
    'quiz_id': 'quiz-linux-scheduling',
    'topic_id': 'linux-scheduling',
    'prompt': 'If scheduling is poor, a likely symptom is:',
    'options': [
      'Better battery health automatically',
      'Laggy interactions and uneven task completion',
      'Instant memory expansion',
      'Perfect throughput for all jobs',
    ],
    'correct_index': 1,
    'explanation': 'Unbalanced CPU allocation can hurt both UX and throughput.',
    'order': 4,
  },
  {
    'id': 'linux-sch-q5',
    'quiz_id': 'quiz-linux-scheduling',
    'topic_id': 'linux-scheduling',
    'prompt': 'Scheduling matters for performance because it affects:',
    'options': [
      'Only UI font rendering',
      'Latency, throughput, and task progress',
      'Only network cables',
      'Only disk labels',
    ],
    'correct_index': 1,
    'explanation':
        'Scheduler policy directly influences system responsiveness and efficiency.',
    'order': 5,
  },
  {
    'id': 'linux-mm-q1',
    'quiz_id': 'quiz-linux-memory-management',
    'topic_id': 'linux-memory-management',
    'prompt': 'Physical memory refers to:',
    'options': [
      'RAM hardware resources',
      'Only swap partition',
      'A shell variable',
      'Kernel logs',
    ],
    'correct_index': 0,
    'explanation': 'Physical memory is the actual installed RAM.',
    'order': 1,
  },
  {
    'id': 'linux-mm-q2',
    'quiz_id': 'quiz-linux-memory-management',
    'topic_id': 'linux-memory-management',
    'prompt': 'Virtual memory helps by:',
    'options': [
      'Removing process isolation',
      'Giving processes isolated address spaces',
      'Disabling paging',
      'Replacing CPU scheduling',
    ],
    'correct_index': 1,
    'explanation':
        'Virtual memory isolates processes and improves flexibility.',
    'order': 2,
  },
  {
    'id': 'linux-mm-q3',
    'quiz_id': 'quiz-linux-memory-management',
    'topic_id': 'linux-memory-management',
    'prompt': 'Paging is best described as:',
    'options': [
      'Splitting memory into manageable fixed-size blocks',
      'Formatting disks every boot',
      'Disabling caches',
      'Stopping all processes',
    ],
    'correct_index': 0,
    'explanation': 'Paging manages memory in fixed-size units for mapping.',
    'order': 3,
  },
  {
    'id': 'linux-mm-q4',
    'quiz_id': 'quiz-linux-memory-management',
    'topic_id': 'linux-memory-management',
    'prompt': 'Swap is useful when:',
    'options': [
      'RAM pressure increases beyond available physical memory',
      'Network latency is high',
      'User passwords expire',
      'Kernel modules fail to load',
    ],
    'correct_index': 0,
    'explanation': 'Swap extends available memory capacity under pressure.',
    'order': 4,
  },
  {
    'id': 'linux-mm-q5',
    'quiz_id': 'quiz-linux-memory-management',
    'topic_id': 'linux-memory-management',
    'prompt': 'Good memory policy mainly improves:',
    'options': [
    ...
    'correct_index': 0,
    'explanation':
        'Efficient allocation and reclamation reduce slowdowns and failures.',
    'order': 5,
  },
  {
    'id': 'linux-fs-q1',
    'quiz_id': 'quiz-linux-file-systems',
    'topic_id': 'linux-file-systems',
    'prompt': 'In Linux, the top of file hierarchy is:',
    'options': ['/', '/home', '/rootfs/tmp', '/kernel'],
    'correct_index': 0,
    'explanation': 'All paths begin from the root directory /.',
    'order': 1,
  },
  {
    'id': 'linux-fs-q2',
    'quiz_id': 'quiz-linux-file-systems',
    'topic_id': 'linux-file-systems',
    'prompt': 'File permissions control:',
    'options': [
      'CPU frequency',
    ...
    'correct_index': 1,
    'explanation':
        'Permissions define who can read, write, or execute content.',
    'order': 2,
  },
  {
    'id': 'linux-fs-q3',
    'quiz_id': 'quiz-linux-file-systems',
    'topic_id': 'linux-file-systems',
    'prompt': 'Mounting a filesystem means:',
    'options': [
      'Deleting all existing directories',
      'Attaching storage into the directory tree',
      'Encrypting user passwords',
      'Disabling symbolic links',
    ],
    'correct_index': 1,
    'explanation': 'Mounting integrates storage at a path in the hierarchy.',
    'order': 3,
  },
  {
    'id': 'linux-fs-q4',
    'quiz_id': 'quiz-linux-file-systems',
    'topic_id': 'linux-file-systems',
    'prompt': 'Ownership in Linux typically includes:',
    'options': [
      'User and group association',
      'Only file size metadata',
      'Only network owner',
      'Only process ID',
    ],
    'correct_index': 0,
    'explanation': 'Ownership combines user and group for access control.',
    'order': 4,
  },
  {
    'id': 'linux-fs-q5',
    'quiz_id': 'quiz-linux-file-systems',
    'topic_id': 'linux-file-systems',
    'prompt': 'Why does filesystem knowledge matter operationally?',
    'options': [
      'It improves wallpaper quality',
      'It supports security, navigation, and troubleshooting',
      'It removes need for backups',
      'It disables logging',
    ],
    'correct_index': 1,
    'explanation':
        'Understanding structure and permissions is essential for safe operations.',
    'order': 5,
  },
  {
    'id': 'linux-io-q1',
    'quiz_id': 'quiz-linux-io-device-interaction',
    'topic_id': 'linux-io-device-interaction',
    'prompt': 'stdin, stdout, and stderr are:',
    'options': [
      'Default process I/O streams',
    ...
    'correct_index': 0,
    'explanation':
        'They are the standard streams used by command-line programs.',
    'order': 1,
  },
  {
    'id': 'linux-io-q2',
    'quiz_id': 'quiz-linux-io-device-interaction',
    'topic_id': 'linux-io-device-interaction',
    'prompt': 'Redirection is used to:',
    'options': [
      'Change kernel version',
      'Route command input/output to files or other streams',
      'Compile modules',
      'Reset user groups',
    ],
    'correct_index': 1,
    'explanation':
        'Redirection controls where command data is read from or written to.',
    'order': 2,
  },
  {
    'id': 'linux-io-q3',
    'quiz_id': 'quiz-linux-io-device-interaction',
    'topic_id': 'linux-io-device-interaction',
    'prompt': 'A pipeline between commands enables:',
    'options': [
      'Direct data flow from one command to another',
      'Automatic root access',
      'Permanent process freezing',
      'File ownership reset',
    ],
    'correct_index': 0,
    'explanation': 'Pipes chain tools by passing output as next input.',
    'order': 3,
  },
  {
    'id': 'linux-io-q4',
    'quiz_id': 'quiz-linux-io-device-interaction',
    'topic_id': 'linux-io-device-interaction',
    'prompt': 'Linux device abstraction is useful because it:',
    'options': [
      'Avoids all drivers',
      'Provides consistent interaction patterns',
      'Disables command-line access',
      'Blocks system calls',
    ],
    'correct_index': 1,
    'explanation':
        'Treating many resources like files simplifies system interactions.',
    'order': 4,
  },
  {
    'id': 'linux-io-q5',
    'quiz_id': 'quiz-linux-io-device-interaction',
    'topic_id': 'linux-io-device-interaction',
    'prompt': 'stderr is valuable operationally because it:',
    'options': [
      'Carries command errors separately from normal output',
      'Only stores binary files',
      'Changes user passwords',
      'Disables logs',
    ],
    'correct_index': 0,
    'explanation':
        'Separating errors helps automation and troubleshooting clarity.',
    'order': 5,
  },
  {
    'id': 'linux-ipc-q1',
    'quiz_id': 'quiz-linux-ipc',
    'topic_id': 'linux-ipc',
    'prompt': 'Why do processes need IPC?',
    'options': [
      'To share information and coordinate work',
      'To replace file systems',
      'To remove security controls',
      'To disable multitasking',
    ],
    'correct_index': 0,
    'explanation':
        'Independent processes still need coordination in real systems.',
    'order': 1,
  },
  {
    'id': 'linux-ipc-q2',
    'quiz_id': 'quiz-linux-ipc',
    'topic_id': 'linux-ipc',
    'prompt': 'Pipes are most useful for:',
    'options': [
      'Chaining command output to another process input',
      'Formatting partitions',
      'Disabling process signals',
      'Changing kernel logs',
    ],
    'correct_index': 0,
    'explanation': 'Pipes are lightweight IPC for stream-based communication.',
    'order': 2,
  },
  {
    'id': 'linux-ipc-q3',
    'quiz_id': 'quiz-linux-ipc',
    'topic_id': 'linux-ipc',
    'prompt': 'Signals are commonly used to:',
    'options': [
      'Send control notifications between processes',
      'Encrypt files directly',
      'Mount new disks',
      'Create new users',
    ],
    'correct_index': 0,
    'explanation':
        'Signals notify processes about events such as interrupts or termination.',
    'order': 3,
  },
  {
    'id': 'linux-ipc-q4',
    'quiz_id': 'quiz-linux-ipc',
    'topic_id': 'linux-ipc',
    'prompt': 'Shared memory is chosen when teams need:',
    'options': [
      'High-speed data sharing between processes',
      'Simpler file permissions only',
      'Automatic backup scheduling',
      'Kernel replacement',
    ],
    'correct_index': 0,
    'explanation':
        'Shared memory can be fast but requires careful synchronization.',
    'order': 4,
  },
  {
    'id': 'linux-ipc-q5',
    'quiz_id': 'quiz-linux-ipc',
    'topic_id': 'linux-ipc',
    'prompt': 'Which IPC tradeoff is correct?',
    'options': [
      'Faster methods can require more coordination complexity',
      'All IPC methods have identical behavior',
      'Signals always carry large data payloads',
      'Pipes cannot move text data',
    ],
    'correct_index': 0,
    'explanation': 'Performance and complexity often trade off in IPC choices.',
    'order': 5,
  },
  {
    'id': 'linux-net-q1',
    'quiz_id': 'quiz-linux-networking-security',
    'topic_id': 'linux-networking-security',
    'prompt': 'Linux networking basics include understanding:',
    'options': [
      'Interfaces and service communication',
    ...
    'correct_index': 0,
    'explanation':
        'Interfaces, routes, and services are key networking concepts.',
    'order': 1,
  },
  {
    'id': 'linux-net-q2',
    'quiz_id': 'quiz-linux-networking-security',
    'topic_id': 'linux-networking-security',
    'prompt': 'Users and groups mainly support:',
    'options': [
    ...
    'correct_index': 0,
    'explanation': 'Identity grouping is foundational for Linux authorization.',
    'order': 2,
  },
  {
    'id': 'linux-net-q3',
    'quiz_id': 'quiz-linux-networking-security',
    'topic_id': 'linux-networking-security',
    'prompt': 'Least privilege in Linux means:',
    'options': [
      'Granting only required permissions',
      'Granting root by default',
      'Ignoring ownership',
      'Disabling updates permanently',
    ],
    'correct_index': 0,
    'explanation': 'Least privilege limits blast radius and misuse potential.',
    'order': 3,
  },
  {
    'id': 'linux-net-q4',
    'quiz_id': 'quiz-linux-networking-security',
    'topic_id': 'linux-networking-security',
    'prompt': 'A practical secure Linux habit is:',
    'options': [
      'Regular updates and service hardening',
      'Same shared admin password everywhere',
      'Disabling logs globally',
      'Running all services as root',
    ],
    'correct_index': 0,
    'explanation': 'Patch and hardening routines strengthen baseline security.',
    'order': 4,
  },
  {
    'id': 'linux-net-q5',
    'quiz_id': 'quiz-linux-networking-security',
    'topic_id': 'linux-networking-security',
    'prompt': 'Permission ownership review helps teams:',
    'options': [
      'Reduce unauthorized access risk',
      'Increase boot time',
      'Remove package managers',
      'Disable shell scripting',
    ],
    'correct_index': 0,
    'explanation':
        'Auditing ownership and permissions prevents accidental overexposure.',
    'order': 5,
  },
];
...
const List<Map<String, Object>> cybersecurityAchievementsMappingSeed = [
  ...
  },
  {
    ...
    'rarity': 'rare',
    'badge_idea': 'Collection shelf with grouped earned badges',
  },
  {
    'id': 'first_linux_lesson',
    'title': 'Linux Boot Sequence',
    'description': 'Complete your first Linux lesson.',
    'unlock_hint': 'Finish any lesson in the Linux learning path',
    'trigger': 'first_linux_lesson',
    'rarity': 'common',
    'badge_idea': 'Terminal prompt with a green check',
  },
  {
    'id': 'first_linux_quiz',
    'title': 'Penguin Pop Quiz',
    'description': 'Submit your first Linux quiz attempt.',
    'unlock_hint': 'Take any Linux topic quiz once',
    'trigger': 'first_linux_quiz',
    'rarity': 'common',
    'badge_idea': 'Quiz card with terminal icon',
  },
  {
    'id': 'linux_topic_complete',
    'title': 'Linux Core Complete',
    'description': 'Complete one Linux topic end-to-end.',
    'unlock_hint': 'Finish all lessons in any Linux topic',
    'trigger': 'linux_topic_complete',
    'rarity': 'rare',
    'badge_idea': 'Kernel ring around a terminal glyph',
  },
  {
    'id': 'linux_history_starter',
    'title': 'History Starter',
    'description': 'Complete Linux History and Overview.',
    'unlock_hint': 'Finish lesson 1 in The Linux System',
    'trigger': 'lesson_complete:linux-l1',
    'rarity': 'common',
    'badge_idea': 'Open book and penguin outline',
  },
  {
    'id': 'kernel_explorer',
    'title': 'Kernel Explorer',
    'description': 'Complete Kernel Modules and Linux Architecture.',
    'unlock_hint': 'Finish lesson 3 in The Linux System',
    'trigger': 'lesson_complete:linux-l3',
    'rarity': 'rare',
    'badge_idea': 'Gear and kernel node diagram',
  },
  {
    'id': 'process_tracker',
    'title': 'Process Tracker',
    'description': 'Complete Process Management in Linux.',
    'unlock_hint': 'Finish lesson 4 in The Linux System',
    'trigger': 'lesson_complete:linux-l4',
    'rarity': 'common',
    'badge_idea': 'Tree graph of parent-child processes',
  },
  {
    'id': 'scheduler_starter',
    'title': 'Scheduler Starter',
    'description': 'Complete Linux Scheduling.',
    'unlock_hint': 'Finish lesson 5 in The Linux System',
    'trigger': 'lesson_complete:linux-l5',
    'rarity': 'common',
    'badge_idea': 'CPU cycle clock with queue bars',
  },
  {
    'id': 'memory_mapper',
    'title': 'Memory Mapper',
    'description': 'Complete Memory Management in Linux.',
    'unlock_hint': 'Finish lesson 6 in The Linux System',
    'trigger': 'lesson_complete:linux-l6',
    'rarity': 'rare',
    'badge_idea': 'Virtual-to-physical memory map',
  },
  {
    'id': 'file_system_explorer',
    'title': 'File System Explorer',
    'description': 'Complete Linux File Systems.',
    'unlock_hint': 'Finish lesson 7 in The Linux System',
    'trigger': 'lesson_complete:linux-l7',
    'rarity': 'common',
    'badge_idea': 'Folder tree with mount point symbol',
  },
  {
    'id': 'terminal_thinker',
    'title': 'Terminal Thinker',
    'description': 'Complete Input, Output, and Device Interaction.',
    'unlock_hint': 'Finish lesson 8 in The Linux System',
    'trigger': 'lesson_complete:linux-l8',
    'rarity': 'common',
    'badge_idea': 'Terminal with redirected arrows',
  },
  {
    'id': 'ipc_novice',
    'title': 'IPC Novice',
    'description': 'Complete Interprocess Communication in Linux.',
    'unlock_hint': 'Finish lesson 9 in The Linux System',
    'trigger': 'lesson_complete:linux-l9',
    'rarity': 'rare',
    'badge_idea': 'Two processes connected by a pipe',
  },
  {
    'id': 'linux_security_guard',
    'title': 'Linux Security Guard',
    'description': 'Complete Linux Networking and Security.',
    'unlock_hint': 'Finish lesson 10 in The Linux System',
    'trigger': 'lesson_complete:linux-l10',
    'rarity': 'rare',
    'badge_idea': 'Shield over users and groups icon',
  },
  {
    'id': 'linux_path_complete',
    'title': 'Linux Learning Path Complete',
    'description': 'Finish all Linux topics and complete their quizzes.',
    'unlock_hint': 'Complete every Linux topic and take all Linux quizzes',
    'trigger': 'linux_path_complete',
    'rarity': 'epic',
    'badge_idea': 'Gold terminal badge with laurel',
  },
];

const List<Map<String, Object>> progressMappingSeed = [
  {
    'topic_id': 'linux-system',
    'tracks_overall_progress': true,
    'tracks_topic_progress': true,
    'continue_learning_enabled': true,
    'quiz_completion_updates_progress': true,
    'achievement_hooks': [
      'first_linux_lesson',
      'first_linux_quiz',
      'linux_topic_complete',
      'linux_path_complete',
    ],
  },
];

const List<Map<String, Object>> homeRecommendationsSeed = [
  {
    'topic_id': 'linux-system',
    'title': 'The Linux System',
    'preview_text':
        'Build Linux system intuition from history and architecture to security.',
    'priority': 1,
    'audience': 'beginner_to_intermediate',
  },
];
